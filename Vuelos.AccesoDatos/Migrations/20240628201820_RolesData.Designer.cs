...
namespace Vuelos.Entities.Migrations
{
    ...
    [Migration("20240628201820_RolesData")]
            ...
            modelBuilder.Entity("Vuelos.Entities.Modelos.VuelosA", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AsientosOcupados = 0,
                            Destino = "ACA",
                            Horario = new DateTime(2024, 6, 29, 18, 18, 20, 497, DateTimeKind.Local).AddTicks(7721),
                            Origen = "MID",
                            Precio = 400.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 4,
                            Destino = "QRO",
                            Horario = new DateTime(2024, 6, 29, 16, 18, 20, 497, DateTimeKind.Local).AddTicks(7732),
                            Origen = "MID",
                            Precio = 800.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 8,
                            Destino = "MTY",
                            Horario = new DateTime(2024, 6, 29, 20, 18, 20, 497, DateTimeKind.Local).AddTicks(7733),
                            Origen = "MID",
                            Precio = 2200.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 12,
                            Destino = "CUN",
                            Horario = new DateTime(2024, 6, 29, 22, 18, 20, 497, DateTimeKind.Local).AddTicks(7735),
                            Origen = "MID",
                            Precio = 2400.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 18,
                            Destino = "TCN",
                            Horario = new DateTime(2024, 6, 29, 14, 18, 20, 497, DateTimeKind.Local).AddTicks(7736),
                            Origen = "MID",
                            Precio = 700.0
                        });
                });
