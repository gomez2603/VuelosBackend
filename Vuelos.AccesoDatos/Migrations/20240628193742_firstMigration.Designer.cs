...
namespace Vuelos.Entities.Migrations
{
    ...
    [Migration("20240628193742_firstMigration")]
            ...
            modelBuilder.Entity("Vuelos.Entities.Modelos.VuelosA", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AsientosOcupados = 0,
                            Destino = "ACA",
                            Horario = new DateTime(2024, 6, 29, 17, 37, 42, 290, DateTimeKind.Local).AddTicks(8665),
                            Origen = "MID",
                            Precio = 400.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 4,
                            Destino = "QRO",
                            Horario = new DateTime(2024, 6, 29, 15, 37, 42, 290, DateTimeKind.Local).AddTicks(8679),
                            Origen = "MID",
                            Precio = 800.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 8,
                            Destino = "MTY",
                            Horario = new DateTime(2024, 6, 29, 19, 37, 42, 290, DateTimeKind.Local).AddTicks(8680),
                            Origen = "MID",
                            Precio = 2200.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 12,
                            Destino = "CUN",
                            Horario = new DateTime(2024, 6, 29, 21, 37, 42, 290, DateTimeKind.Local).AddTicks(8682),
                            Origen = "MID",
                            Precio = 2400.0
                        },
                        new
                        {
                            ...
                            AsientosOcupados = 18,
                            Destino = "TCN",
                            Horario = new DateTime(2024, 6, 29, 13, 37, 42, 290, DateTimeKind.Local).AddTicks(8683),
                            Origen = "MID",
                            Precio = 700.0
                        });
                });
