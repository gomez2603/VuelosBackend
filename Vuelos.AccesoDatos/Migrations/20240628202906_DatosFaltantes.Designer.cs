...
namespace Vuelos.Entities.Migrations
{
    ...
    [Migration("20240628202906_DatosFaltantes")]
    partial class DatosFaltantes
    {
            ...
            modelBuilder.Entity("Vuelos.Entities.Modelos.VuelosA", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Destino = "ACA",
                            DuracionViaje = "1:25",
                            Horario = new DateTime(2024, 6, 29, 18, 29, 6, 127, DateTimeKind.Local).AddTicks(2649),
                            Origen = "MID",
                            Precio = 400.0
                        },
                        new
                        {
                            ...
                            Destino = "QRO",
                            DuracionViaje = "2:35",
                            Horario = new DateTime(2024, 6, 29, 16, 29, 6, 127, DateTimeKind.Local).AddTicks(2660),
                            Origen = "MID",
                            Precio = 800.0
                        },
                        new
                        {
                            ...
                            Destino = "MTY",
                            DuracionViaje = "1:45",
                            Horario = new DateTime(2024, 6, 29, 20, 29, 6, 127, DateTimeKind.Local).AddTicks(2661),
                            Origen = "MID",
                            Precio = 2200.0
                        },
                        new
                        {
                            ...
                            Destino = "CUN",
                            DuracionViaje = "1:05",
                            Horario = new DateTime(2024, 6, 29, 22, 29, 6, 127, DateTimeKind.Local).AddTicks(2662),
                            Origen = "MID",
                            Precio = 2400.0
                        },
                        new
                        {
                            ...
                            Destino = "TCN",
                            DuracionViaje = "0:35",
                            Horario = new DateTime(2024, 6, 29, 14, 29, 6, 127, DateTimeKind.Local).AddTicks(2663),
                            Origen = "MID",
                            Precio = 700.0
                        });
                });
